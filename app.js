...
// The fix is here: access the 'rates' property of the data object
let rate = data.rates[toCurr.value]; 

// The final amount is already calculated by the API.
// It's the value of the 'rate' for the target currency.
